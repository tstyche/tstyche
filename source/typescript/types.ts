...
export type Declaration = tsAst.Declaration | ts6.Declaration;
...
export type GenericType = tsApi.GenericType | ts6.GenericType;
...
export type TypeParameterDeclaration = tsAst.TypeParameterDeclaration | ts6.TypeParameterDeclaration;
