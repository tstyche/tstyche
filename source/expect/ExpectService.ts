...
export class ExpectService {
  ...
  constructor(compiler: typeof ts, typeChecker: TypeChecker, reject: Reject, resolvedConfig: ResolvedConfig) {
    this.#compiler = compiler;
    this.#reject = reject;
    this.#typeChecker = typeChecker;

    this.toAcceptProps = new ToAcceptProps(compiler, typeChecker);
    this.toBe = resolvedConfig.legacyToBe ? new LegacyToBe() : new ToBe(compiler, typeChecker);
